...
import { RATE_COLUMNS } from 'src/app/core/configs/rates.column.config';

@Component({
  selector: 'app-newspaper-media-profile',
  templateUrl: './newspaper-media-profile.component.html',
  styleUrls: ['./newspaper-media-profile.component.scss'],
})
export class NewspaperMediaProfileComponent implements OnInit {
